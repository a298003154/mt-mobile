<template>
  <section class="mt-doc-demo-pages">
    <h1>{{ $t('title') }}</h1>
    <div class="card">
      <p>{{ $t('description') }}</p>
      <div class="mt-doc-demo-pages__gallery">
        <div
          :class="['mt-doc-demo-pages__item',
          { 'mt-doc-demo-pages__item--active': index === currentDemo }]"
